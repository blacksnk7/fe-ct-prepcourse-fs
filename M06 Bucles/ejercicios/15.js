...
console.log(obtenerDiaSemana(1), obtenerDiaSemana(2), obtenerDiaSemana(3), obtenerDiaSemana(4), obtenerDiaSemana(5), obtenerDiaSemana(6), obtenerDiaSemana(7), obtenerDiaSemana(-6), obtenerDiaSemana("Hola"))
